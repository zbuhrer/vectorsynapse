...
from lib.proximity_mapper_state import ClearedTerritory, MapState, Wall, WallSegment   # pylint: disable=wrong-import-position
...
import anki_vector.proximity as anki_vector_prox
...
async def analyze_proximity_sample(reading: anki_vector_prox.ProximitySensorData, robot: anki_vector.robot.Robot, state: MapState):
